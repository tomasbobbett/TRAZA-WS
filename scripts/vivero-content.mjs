...
export function renderNursery() {
    ...
    <main id="contenido">
        ...
        <section class="nursery-faq section" id="preguntas"><div class="shell nursery-faq-grid"><div class="reveal"><h2 class="section-title">Resolvamos<br><em>tus dudas.</em></h2></div><div class="nursery-faq-list">${nurseryFAQs.map(([question,answer])=>`<details><summary>${question}</summary><p>${answer}</p></details>`).join('')}</div></div></section>
        <section class="nursery-location section" id="visitanos"><div class="shell nursery-location-grid"><div class="reveal"><h2 class="section-title">El Torno.<br><em>Bolivia.</em></h2><p>Vivero la Loma · 2J5J+7W, El Torno, Bolivia</p><a class="button button-primary" href="${map}" ${external}>Cómo llegar <span>↗</span></a><a class="nursery-location-contact" href="${wa}" ${external}>Coordinar una visita <span>↗</span></a></div><div class="nursery-location-note reveal"><span class="nursery-location-mark" aria-hidden="true">↗</span><h3>Una conversación.<br>Muchas posibilidades.</h3><p>Antes de visitarnos, confirmá el horario y las plantas que te interesan por WhatsApp.</p><a href="tel:+59172139484">+591 72139484</a></div></div></section>
    </main>

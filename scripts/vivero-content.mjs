    ...
    <main id="contenido">
        <header class="hero nursery-hero" id="inicio">
            ...
            <div class="hero-content shell">
                <p class="eyebrow reveal">El Torno, Bolivia · Vivero de frutales injertados</p>
        ...
        <section class="nursery-intro section" id="proyectos">
            <div class="shell"><div class="catalog-heading reveal"><div><p class="section-index">01 / CADA PROYECTO TIENE SU RAÍZ</p><h2 class="section-title">Tu objetivo.<br><em>Nuestro punto de partida.</em></h2></div><p class="section-copy">Una plantación productiva, un programa municipal o una iniciativa comunitaria. La propuesta empieza por entender para quién plantamos.</p></div>
        ...
        <section class="plant-catalog section" id="catalogo" aria-labelledby="catalog-title"><div class="shell">
            <div class="catalog-heading reveal"><div><p class="section-index">02 / EXPLORÁ LAS POSIBILIDADES</p><h2 class="section-title" id="catalog-title">El próximo fruto<br><em>empieza acá.</em></h2></div><p class="section-copy">Elegí una especie como punto de partida. Consultamos variedad, cantidad y destino para preparar tu pedido.</p></div>
        ...
        <section class="nursery-process section" id="experiencia"><div class="shell nursery-process-grid">
            <div class="reveal"><p class="section-index">03 / DEL PROYECTO AL PEDIDO</p><h2 class="section-title">Hagamos lugar<br><em>a lo que viene.</em></h2><p class="section-copy">Para cotizar con claridad, empecemos por los datos que importan.</p><a class="button button-primary" href="#cotizar">Empezar mi consulta <span>↗</span></a></div>
        ...
        <section class="nursery-quote section" id="cotizar"><div class="shell nursery-quote-grid">
            ...
            <form class="nursery-form" id="nursery-quote" action="https://wa.me/${nursery.whatsapp}" method="get">
                ...
                <div class="nursery-result" hidden><p class="nursery-form-status" role="status" aria-live="polite"></p><pre class="nursery-message-preview"></pre><a class="button button-primary" data-quote-link href="${wa}" ${external}>Enviar por WhatsApp <span>↗</span></a></div>
            </form>
        </div></section>
        <section class="nursery-faq section" id="preguntas"><div class="shell nursery-faq-grid"><div class="reveal"><p class="section-index">ANTES DE PLANTAR</p><h2 class="section-title">Resolvamos<br><em>tus dudas.</em></h2></div><div class="nursery-faq-list">${nurseryFAQs.map(([question,answer])=>`<details><summary>${question}</summary><p>${answer}</p></details>`).join('')}</div></div></section>
        <section class="nursery-location section" id="visitanos"><div class="shell nursery-location-grid"><div class="reveal"><p class="section-index">NUESTRAS RAÍCES ESTÁN ACÁ</p><h2 class="section-title">El Torno.<br><em>Bolivia.</em></h2><p>Vivero la Loma · 2J5J+7W, El Torno, Bolivia</p><a class="button button-primary" href="${map}" ${external}>Cómo llegar <span>↗</span></a><a class="nursery-location-contact" href="${wa}" ${external}>Coordinar una visita <span>↗</span></a></div><div class="nursery-location-note reveal"><span class="nursery-location-mark" aria-hidden="true">↗</span><h3>Una conversación.<br>Muchas posibilidades.</h3><p>Antes de visitarnos, confirmá el horario y las plantas que te interesan por WhatsApp.</p><a href="tel:+59172139484">+591 72139484</a></div></div></section>
    </main>

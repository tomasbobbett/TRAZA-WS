...
export function renderNursery() {
    ...
    const pager = target => `<div class="nursery-pager" data-pager="${target}" hidden><button type="button" data-page-prev aria-label="Anterior">←</button><span data-page-position aria-live="polite"></span><button type="button" data-page-next aria-label="Siguiente">→</button></div>`;
    return `
    ...
    <main id="contenido">
        ...
        <section class="nursery-intro section" id="proyectos">
            ...
            <div class="nursery-buyers" id="buyer-slides" data-carousel tabindex="0" aria-label="Propuestas por tipo de cliente">
        ...
        <section class="nursery-process section" id="experiencia"><div class="shell nursery-process-grid">
            <div class="reveal"><h2 class="section-title">Hagamos lugar<br><em>a lo que viene.</em></h2><p class="section-copy">Para cotizar con claridad, empecemos por los datos que importan.</p><a class="button button-primary" href="#cotizar">Empezar mi consulta <span>↗</span></a></div>
            <div class="nursery-process-slides"><ol class="nursery-steps" id="process-slides" data-carousel tabindex="0" aria-label="Cómo realizar tu pedido"><li class="reveal"><span>01</span><div><h3>Contanos tu proyecto</h3><p>Tipo de comprador, zona de plantación, especies y cantidad aproximada. Podés consultar aunque todavía estés definiendo los detalles.</p></div></li><li class="reveal"><span>02</span><div><h3>Confirmemos la propuesta</h3><p>Solicitá variedades, portainjertos, tamaño, disponibilidad y precio. Para compras institucionales, agregá tus requisitos de documentación.</p></div></li><li class="reveal"><span>03</span><div><h3>Coordinemos el siguiente paso</h3><p>Acordá con el vivero las condiciones de pago, el retiro o la entrega y los plazos antes de confirmar el pedido.</p></div></li></ol>${pager("process-slides")}</div>
        </div></section>
        <section class="nursery-quote section" id="cotizar"><div class="shell nursery-quote-grid">
            ...
            <form class="nursery-form" id="nursery-quote" action="https://wa.me/${nursery.whatsapp}" method="get">
                ...
                <div class="nursery-form-fields" hidden>
                    <div class="nursery-form-progress"><span data-form-progress role="status" aria-live="polite"></span><span data-form-step-title></span></div>
                    <div class="nursery-form-step" data-quote-step="0">
                    ...
                    <div class="nursery-form-step" data-quote-step="1" hidden>
                    ...
                    <div class="nursery-form-step" data-quote-step="2" hidden>
                    ...
                    <div class="nursery-form-step" data-quote-step="3" hidden>
                    ...
                    <div class="nursery-form-actions"><button class="nursery-back" type="button" data-form-back hidden>Anterior</button><button class="button button-primary" type="button" data-form-next>Continuar <span>→</span></button><button class="button button-primary" type="submit" data-form-submit hidden>Preparar cotización <span>↗</span></button></div>
                    <p class="nursery-small nursery-field-wide">* Datos obligatorios. Nada se envía automáticamente.</p>
                </div>
                ...
                <div class="nursery-result" hidden><button class="nursery-back" type="button" data-form-edit>← Editar datos</button><p class="nursery-form-status" role="status" aria-live="polite"></p><pre class="nursery-message-preview"></pre><a class="button button-primary" data-quote-link href="${wa}" ${external}>Enviar por WhatsApp <span>↗</span></a></div>
            </form>
        </div></section>
        <section class="nursery-faq section" id="preguntas"><div class="shell nursery-faq-grid"><div class="reveal"><h2 class="section-title">Resolvamos<br><em>tus dudas.</em></h2></div><div class="nursery-faq-content"><div class="nursery-faq-picker" hidden><label for="nursery-question">Elegí una pregunta</label><select id="nursery-question">${nurseryFAQs.map(([question], index)=>`<option value="${index}">${question}</option>`).join('')}</select></div><div class="nursery-faq-list">${nurseryFAQs.map(([question,answer])=>`<details><summary>${question}</summary><p>${answer}</p></details>`).join('')}</div></div></div></section>
        <section class="nursery-location section" id="visitanos"><div class="shell nursery-location-shell"><div class="nursery-location-grid"><div class="reveal"><h2 class="section-title">El Torno.<br><em>Bolivia.</em></h2><p>Vivero la Loma · 2J5J+7W, El Torno, Bolivia</p><a class="button button-primary" href="${map}" ${external}>Cómo llegar <span>↗</span></a><a class="nursery-location-contact" href="${wa}" ${external}>Coordinar una visita <span>↗</span></a></div><div class="nursery-location-note reveal"><span class="nursery-location-mark" aria-hidden="true">↗</span><h3>Una conversación.<br>Muchas posibilidades.</h3><p>Antes de visitarnos, confirmá el horario y las plantas que te interesan por WhatsApp.</p><a href="tel:+59172139484">+591 72139484</a></div></div>    <footer class="footer"><div><b>Vivero la Loma</b><span>Frutales injertados · El Torno, Bolivia</span></div><a href="#cotizar">Hablemos de tu proyecto ↗</a></footer>
    <p class="demo-disclaimer">Demo comercial de TRAZA para Vivero la Loma. Fotografías y especies ilustrativas; catálogo, precios y disponibilidad a confirmar. Las consultas se dirigen al WhatsApp del vivero; no se realizan reservas ni compras automáticas.</p></div></section>
    </main>

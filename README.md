...
En escritorio, cada sección de Vivero la Loma ocupa el alto visible de la pantalla y conserva la distribución original. Los tamaños y espacios se adaptan también a ventanas bajas. En pantallas de hasta 960 px, las secciones con más contenido pueden crecer y se recorren con scroll, para mantener todo legible. El formulario conserva todos sus campos a la vista; la consulta preparada se revisa en un diálogo que permite volver a editar sin perder los datos. Las preguntas muestran una respuesta por vez.

...
El vivero suaviza la rueda del mouse con [Lenis 1.3.26](https://github.com/darkroomengineering/lenis), servido localmente desde `webs/assets/vendor/lenis-1.3.26/` con su licencia MIT. Conserva el desplazamiento nativo al tocar la pantalla, usar el teclado o seguir un enlace interno. La inercia se detiene al abrir el menú o la revisión de la consulta; los campos y el mensaje mantienen su scroll propio. La preferencia de movimiento reducido desactiva el suavizado, también si cambia durante la visita. La navegación usa un fondo opaco para evitar recalcular el desenfoque al desplazar la página.
